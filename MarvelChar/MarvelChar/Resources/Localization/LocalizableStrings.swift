...
struct LocalizableStrings {
    static let avengersComma = "AVENGERS_COMMA".localizedString()
    static let assembleExclamation = "ASSEMBLE_EXCLAMATION".localizedString()
    static let search = "SEARCH".localizedString()
